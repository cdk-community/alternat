...
export const DEFAULT_EBS_VOLUME_DEVICE_NAME = '/dev/sda1';

export const DEFAULT_EBS_VOLUME_OPTIONS: ec2.EbsDeviceOptions = {
  encrypted: true,
  volumeType: ec2.EbsDeviceVolumeType.GP3,
  deleteOnTermination: true,
};

export const DEFAULT_EBS_VOLUME_SIZE = 50;
...
export const EBS_BLOCK_DEVICE: ec2.BlockDevice = {
  deviceName: DEFAULT_EBS_VOLUME_DEVICE_NAME,
  volume: ec2.BlockDeviceVolume.ebs(
    DEFAULT_EBS_VOLUME_SIZE,
    DEFAULT_EBS_VOLUME_OPTIONS
  ),
};
